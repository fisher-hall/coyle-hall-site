document.addEventListener("DOMContentLoaded", function () {
  var countdownSection = document.getElementById("car-smash-countdown-section");
  ...
  var countdownD = document.getElementById("car-smash-countdown-days");
  var countdownH = document.getElementById("car-smash-countdown-hours");
  var countdownM = document.getElementById("car-smash-countdown-mins");
  var countdownS = document.getElementById("car-smash-countdown-secs");
  var countdownDivider = document.getElementById("car-smash-countdown-divider");
